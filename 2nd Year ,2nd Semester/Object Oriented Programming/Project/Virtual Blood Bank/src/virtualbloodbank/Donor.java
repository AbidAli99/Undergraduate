...
public class Donor {
    private int id, age;
    private String name, fathersName, mothersName, gender, weight, bloodGroup, maritalStatus, nid, mobileNo, diseases, division, district, address, lastDonation;
    ...
    Donor(int age, String name, String fathersName, String mothersName, String gender, String weight, String bloodGroup,
            ...
            String address, String lastDonation, InputStream picture) {
    ...
    Donor(int id, String name, String gender, int age, String weight, String bloodGroup, String lastDonation,
