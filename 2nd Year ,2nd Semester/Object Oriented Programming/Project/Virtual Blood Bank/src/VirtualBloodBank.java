...
import virtualbloodbank.About;
import virtualbloodbank.AddNewDonor;
import virtualbloodbank.Database;
import virtualbloodbank.Developers;
import virtualbloodbank.Donor;
import virtualbloodbank.Help;
import virtualbloodbank.ViewProfile;
public class VirtualBloodBank {
    
    private final ImageIcon icon, poster;

    private final JFrame frameHome = new JFrame("Virtual Blood Bank");
    ...
    public void showSearchedData(String value) {
        ...
        try {
            ...
            System.out.println("VirtualBloodBank.showTableData(): " + ex);
            ex.printStackTrace();
        }
    }
